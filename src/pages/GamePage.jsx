...
function CornerWidget({
  ...
  // avatar box style — matches reference image style
  const avatarBox = (
    <div
      style={{
        width: 54,
      ...
      <div
        style={{
          ...
          height: 28,
          borderRadius: "50%",
          background: `radial-gradient(circle at 35% 35%, rgba(255,255,255,0.8), ${hex})`,
          border: `2px solid ${isActive ? hex : "rgba(255,255,255,0.4)"}`,
          display: "flex",
          alignItems: "center",
          justifyContent: "center",
          fontSize: 14,
  ...
  // dice box — matches reference image style (frosted glass look)
  const diceBox = (
    <div style={{ position: "relative" }}>
      <div
        ...
        <svg
          ...
          {!isActive && (
            <circle cx="50" cy="50" r="16" fill={hex} opacity=".2" />
          )}
        </svg>
        {/* rolled value */}
      ...
      {/* Emoji picker trigger — small button */}
      <button
        onClick={() => setShowPicker((p) => !p)}
        style={{
          position: "absolute",
          ...(isTop ? { bottom: -18 } : { top: -18 }),
          ...(isLeft ? { right: 0 } : { left: 0 }),
          background: showPicker ? `${hex}44` : "rgba(255,255,255,0.15)",
          border: "none",
          borderRadius: 6,
          padding: "1px 5px",
          fontSize: 12,
  ...
  // Layout: avatar and dice side by side, order depends on corner
  return (
    <div
      style={{
        display: "flex",
  ...
  return (
    <div
      ...
      {/* ════════════════════════════════════════════════════
          ...
          ├──────────────────────────────────────┤
          │         LUDO BOARD (full width)       │  ← board fills space
          ├──────────────────────────────────────┤
        ...
        <div
          ...
          <div
            style={{
              ...
              borderRadius: 16,
              padding: 6,
              boxShadow: "0 0 0 3px #bf5010, 0 8px 40px rgba(0,0,0,0.6)",
            }}>
            <div
              style={{
                width: "100%",
