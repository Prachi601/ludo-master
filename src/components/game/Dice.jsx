...
export default function Dice({ value, rolling, onRoll, canRoll, activeColor }) {
  ...
  const activeHex = colorMap[activeColor] || "#f5c842";
    ...
    <div className="dice-wrap">
      <div
        ...
        <svg viewBox="0 0 100 100" width="60" height="60">
          {/* No stroke/border — removed stroke and strokeWidth */}
          <rect
            width="100"
            height="100"
            rx="16"
      ...
      {/* Show rolled value only — no TAP, no Waiting, no extra turn text */}
      {value && !rolling && (
        <p
          style={{
            color: activeHex,
